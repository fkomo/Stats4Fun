...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DELIMITER $ $ CREATE PROCEDURE fun.ListEnumStates() BEGIN
select
	*
from
	fun.EnumState;

END $ $ CREATE PROCEDURE fun.ListEnumCompetitions() BEGIN
select
	*
from
	fun.EnumCompetition
...
END $ $ CREATE PROCEDURE fun.ListEnumTeams() BEGIN
select
	*
from
	fun.EnumTeam
...
END $ $ CREATE PROCEDURE fun.ListEnumPlayerPositions() BEGIN
select
	*
from
...
END $ $ CREATE PROCEDURE fun.ListEnumMatchTypes() BEGIN
select
	*
from
	fun.EnumMatchType
...
END $ $ CREATE PROCEDURE fun.ListEnumPlaces() BEGIN
select
	*
from
	fun.EnumPlace
...
END $ $ CREATE PROCEDURE fun.ListSeasons() BEGIN
select
...
END $ $ CREATE PROCEDURE fun.ListEnumPlayers (in activeOnly bit) BEGIN
select
	Id,
	Name
from
...
END $ $ CREATE PROCEDURE fun.ListMatches (
	in season int,
	in teamId int,
	in matchTypeId int,
...
END $ $ CREATE PROCEDURE fun.GetMatch (in matchId int) BEGIN
select
	m.Id,
	m.DateTime,
...
END $ $ CREATE PROCEDURE fun.InsertMatch (
...
END $ $ CREATE PROCEDURE fun.ModifyMatch (
	in matchId int,
	in dateTime datetime,
	in matchTypeId int,
	in placeId int,
...
END $ $ CREATE PROCEDURE fun.DeleteMatch (in matchId int) BEGIN
update
	PlayerStats
set
	StateId = 1
...
END $ $ CREATE PROCEDURE fun.MatchesStats (
	in season int,
	in teamId int,
	in matchTypeId int,
	in competitionId int,
...
END $ $ CREATE PROCEDURE fun.ListPlayerStats (
	in season int,
	in teamId int,
	in matchTypeId int,
	in placeId int,
...
END $ $ CREATE PROCEDURE fun.ListMatchPlayerStats (in matchId int) BEGIN
select
...
END $ $ CREATE PROCEDURE fun.InsertMatchPlayerStats (
	in playerId int,
	in matchId int,
	in goals int,
	in assists int,
...
END $ $ CREATE PROCEDURE fun.ModifyMatchPlayerStats (
...
END $ $ CREATE PROCEDURE fun.DeleteMatchPlayerStats (in playerStatsId int) BEGIN
update
	PlayerStats
set
	StateId = 1
...
END $ $ CREATE PROCEDURE fun.GetPlayer (in playerId int) BEGIN
select
	Id,
	Name,
	Number,
...
END $ $ CREATE PROCEDURE fun.InsertPlayer (
...
END $ $ CREATE PROCEDURE fun.ModifyPlayer (
	in dateofBirth datetime,
	in name nvarchar(50),
	in number int,
	in playerPositionId int,
...
END $ $ CREATE PROCEDURE fun.DeletePlayer (in playerId int) BEGIN
update
	Player
set
	StateId = 1
...
END $ $ CREATE PROCEDURE fun.ListCompetitions (in season int) BEGIN
select
...
END $ $ CREATE PROCEDURE fun.TopPlayerGoals (in count int, in teamId int) BEGIN
select
	Player.Id as PlayerId,
...
END $ $ CREATE PROCEDURE fun.TopPlayerAssists (in count int, in teamId int) BEGIN
select
	Player.Id as PlayerId,
	Player.Name as PlayerName,
	EnumPlayerPosition.Name as PlayerPosition,
...
END $ $ CREATE PROCEDURE fun.TopPlayerPoints (in count int, in teamId int) BEGIN
select
	Player.Id as PlayerId,
	Player.Name as PlayerName,
	EnumPlayerPosition.Name as PlayerPosition,
...
END $ $ CREATE PROCEDURE fun.TopPlayerPosNegPoints (in count int, in teamId int) BEGIN
select
	Player.Id as PlayerId,
	Player.Name as PlayerName,
	EnumPlayerPosition.Name as PlayerPosition,
...
END $ $ CREATE PROCEDURE fun.BottomPlayerPosNegPoints (in count int, in teamId int) BEGIN
select
	Player.Id as PlayerId,
	Player.Name as PlayerName,
	EnumPlayerPosition.Name as PlayerPosition,
...
END $ $ CREATE PROCEDURE fun.TopTeamGoalsScored (in count int, in teamId int) BEGIN
select
	m.Id as MatchId,
	m.DateTime as MatchDateTime,
	EnumMatchType.Name as MatchType,
...
END $ $ CREATE PROCEDURE fun.TopTeamGoalsTaken (in count int, in teamId int) BEGIN
select
	m.Id as MatchId,
	m.DateTime as MatchDateTime,
	EnumMatchType.Name as MatchType,
...
END $ $ CREATE PROCEDURE fun.TopTeamScore (in count int, in teamId int) BEGIN
select
	m.Id as MatchId,
	m.DateTime as MatchDateTime,
	EnumMatchType.Name as MatchType,
...
END $ $ CREATE PROCEDURE fun.BottomTeamScore (in count int, in teamId int) BEGIN
select
	m.Id as MatchId,
	m.DateTime as MatchDateTime,
	EnumMatchType.Name as MatchType,
...
END $ $ CREATE PROCEDURE fun.AllSeasonsStats (in teamId int) BEGIN
select
	case
...
END $ $ CREATE PROCEDURE fun.FixMatchWinLossTie() BEGIN
update
	fun.Match m
